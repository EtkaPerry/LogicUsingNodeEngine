...
/**
 * The dyed blocks Lune looks for, on Minecraft 26.1.2.
 *
...
public final class DyedBlocks {
    ...
    public static final Block WHITE_BED = Blocks.WHITE_BED;
    public static final Block WHITE_BANNER = Blocks.WHITE_BANNER;
    public static final Block WHITE_WALL_BANNER = Blocks.WHITE_WALL_BANNER;
